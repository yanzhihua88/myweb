...
//			rados.confSet("mon_host", "10.10.1.4");
//			rados.confSet("key", "AQB4tM5a3XDDJBAAz0ZtOirwcjvWdTtHFmwZng==");
//			rados.connect();
...
//
//	/**
//	 * 以格式2创建image，ceph 仅支持克隆 format 2 映像（即用 rbd create –format 2 创建的），而且内核 rbd
//	 * 模块还不支持。 所以现在你 只能用 QEMU/KVM 或 librbd直接访问克隆品
//	 * 
//	 * @param imageName
//	 *            名称
//	 * @param imageSize
