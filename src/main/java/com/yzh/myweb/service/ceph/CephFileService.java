...
public class CephFileService implements ICephFileService {
    ...
    public CephFileService(String cephEnv, String cephProjectName, String accessKey, String secretKey, String host) {
        this.cephEnv = cephEnv;
        this.cephProjectName = cephProjectName;
        cephStorageService = new CephStorageService(accessKey, secretKey, host);
    }

    private String getBucketName(String bucketName) {
        return cephEnv + "-" + cephProjectName + "-" + bucketName;
    }
